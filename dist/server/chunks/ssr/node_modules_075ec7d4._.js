...
"[project]/node_modules/linkify-react/dist/linkify-react.mjs [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ function stringToElements(str, opts, meta) {
    const tokens = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$linkifyjs$2f$dist$2f$linkify$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tokenize"])(str);
    const elements = [];
    for(let i = 0; i < tokens.length; i++){
        const token = tokens[i];
        if (token.t === 'nl' && opts.get('nl2br')) {
            const key = `__linkify-el-${meta.elementId++}`;
            elements.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createElement"])('br', {
                key
            }));
            ...
            if (!('key' in rendered.props)) {
                ...
                const key = `__linkify-el-${meta.elementId++}`;
                const props = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$linkifyjs$2f$dist$2f$linkify$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["options"].assign({
                    key
                }, rendered.props);
                rendered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cloneElement"])(rendered, props);
            }
 ...
 */ function linkifyReactElement(element, opts, meta) {
    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Children"].count(element.props.children) === 0) {
        // No need to clone if the element had no children
        return element;
    }
    const children = [];
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Children"].forEach(element.props.children, (child)=>{
    ...
    const key = `__linkify-el-${meta.elementId++}`;
    const newProps = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$linkifyjs$2f$dist$2f$linkify$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["options"].assign({
        key
    }, element.props);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cloneElement"])(element, newProps, children);
}
/**
 * @template P
 * @template {string | React.JSXElementConstructor<P>} T
 ...
 */ const Linkify = (props)=>{
    ...
    const defaultLinkRender = ({ tagName, attributes, content })=>{
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createElement"])(tagName, attributes, content);
    };
    const newProps = {
    ...
    const opts = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$linkifyjs$2f$dist$2f$linkify$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Options"](props.options, defaultLinkRender);
    const as = props.as || props.tagName || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"] || 'span';
    const children = props.children;
    const element = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createElement"])(as, newProps, children);
...
//# sourceMappingURL=node_modules_075ec7d4._.js.map